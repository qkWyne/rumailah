...
class _SelectStoreLocationState extends State<SelectStoreLocation> {
  ...
  final List<Map<String, dynamic>> stores = [
    ...
    },
    {
      ...
      "distance": "4 km",
      "address": "809 Jumeirah St - Umm Suqeim-Umm Suqeim 3\nDubai - United Arab Emirates",
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Location", style: TextStyle(color: Color(0xFF6E7075)),),
        ),
        body: Center(
          child: Container(
                                    ...
                                    children: [
                                      Text("${stores[index]["name"]}",
                                        style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.bold,
                                          color: Color(0xFF4E5D3B), // Greenish color
                                        ),
                                      ),
                                      SizedBox(height: 4),
                                      Text(
                                        "${stores[index]["distance"]}",
                                        style: TextStyle(color: Color(0xFF07074F), fontSize: 14),
                                      ),
                                      SizedBox(height: 4),
                                      Text(
