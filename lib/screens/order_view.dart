...
class OrderView extends StatefulWidget {
  ...
  const OrderView({super.key,required this.storeName});
...
class _OrderViewState extends State<OrderView> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> filteredItems = orderMenu
        .where((store) =>
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DetailPage(item: item,storeName: widget.storeName,),
                              ),
                            );
                          },
                          child: Container(
