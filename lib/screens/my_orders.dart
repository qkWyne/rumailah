    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
                indicatorWeight: 8,
                indicatorColor: Color(0xFF4D5E47),
                tabs: [
                  Tab(
                    child: Align(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        String selectedOrderStatus=
                        completedOrders[index]["orderStatus"];
                        String selectedOrderNo =
                            completedOrders[index]["orderNo"];
                        List<Map<String, dynamic>> selectedOrders =
                            completedOrders
                                .where((order) =>
                                    order["orderNo"] == selectedOrderNo)
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      completedOrders[index]["storeName"]
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        String selectedOrderStatus=
                        canceledOrders[index]["orderStatus"];
                        String selectedOrderNo =
                            canceledOrders[index]["orderNo"];
                        List<Map<String, dynamic>> selectedOrders =
                            canceledOrders
                                .where((order) =>
                                    order["orderNo"] == selectedOrderNo)
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      canceledOrders[index]["storeName"]
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
